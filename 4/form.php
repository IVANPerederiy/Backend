    ...
    <div class="form-container">
        <form method="POST" action="">
            <div class="name-block">
                ...
                <input type="text" class="form-control" name="name" aria-describedby="basic-addon1" placeholder="Kujo Jotaro" />
            </div>
            <div class="email-block">
                <span class="input-group-text block-title" id="basic-addon2">Email</span>
                <input type="text" class="form-control" name="email" aria-describedby="basic-addon2" placeholder="jojo@mail.ru" />
            </div>
