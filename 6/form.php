    ...
    <div class="form-container">
        ...
        <form method="POST" action="">
            <div class="name-block">
                ...
                <input type="text" class="form-control" name="name" placeholder="Kujo Jotaro" <?php if ($errors['name']) {
                                                                                                    print 'class="error"';
                                                                                                } ?> value="<?php print $values['name']; ?>" />
            </div>
            <div class="email-block">
                <span class="input-group-text block-title" id="basic-addon2">Email</span>
                <input type="text" class="form-control" name="email" placeholder="jojo@mail.ru" <?php if ($errors['email']) {
                                                                                                    print 'class="error"';
